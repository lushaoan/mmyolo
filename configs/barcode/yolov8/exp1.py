...
# -----data related-----
img_scale = (1280, 800)  # width, height
# Dataset type, this will be used to define the dataset
dataset_type = "YoloBarcodeDataset"
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        train_file_infos=[
            {
                "root": "/dataset/shaoanlu/github/mmlab/yolo_test_dataset/yolotemp/",
                "path": "/dataset/shaoanlu/github/mmlab/yolo_test_dataset/yolotemp/train_data.txt",
            }
        ],
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        train_file_infos=[
            {
                "root": "/dataset/shaoanlu/github/mmlab/yolo_test_dataset/yolotemp/",
                "path": "/dataset/shaoanlu/github/mmlab/yolo_test_dataset/yolotemp/train_data_test.txt",
            }
        ],
